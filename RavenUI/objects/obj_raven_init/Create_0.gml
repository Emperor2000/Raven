...
overview_button = new RavenItem("Overview", undefined);
new_button = new RavenItem("New", undefined);
save_button = new RavenItem("Save", undefined);
view_button = new RavenItem("View", undefined);
undo_button = new RavenItem("Undo", undefined);
redo_button = new RavenItem("Redo", undefined);
export_button = new RavenItem("Export", undefined);
preferences_button = new RavenItem("Preferences", undefined);
variables_button = new RavenItem("variables", undefined);
changelog_button = new RavenItem("Changelog", undefined);
...
item_status = new RavenStatusItem(_map , GUI_STATUS.ERROR, "Status", 16, 8, 16, true);
item_status.SetCurrentValue("approved");
item_status.SetDisplayCurrentValue(true);
item_status_err = new RavenStatusItem(_map , GUI_STATUS.WARNING, "Status", 16, 8, 16, true);
item_status_err.SetCurrentValue("rejected");
item_status_warning = new RavenStatusItem(_map , GUI_STATUS.WARNING, "Status", 16, 8, 16, true);
item_status_warning.SetCurrentValue("warning");
...
_status_notification_container.AddItem(new RavenNodeItem(undefined, undefined, undefined, 16, spr_node, spr_node_white_fill, 2, 2));
